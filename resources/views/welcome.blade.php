...
@section('meta')
    <meta name="keywords"           content="ideacreativa,web,developer" />
...
@section('main')
    <section id="hero-animated" class="hero-animated d-flex align-items-center">
        <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
            <img src="assets/img/hero-carousel/hero-carousel-3.svg" class="img-fluid animated" alt="{{ setting('site.title') ?? 'IdeaCreativa' }}">
            <h2>Bienvenido a Idea<span>Creativa</span></h2>
            <p>{{ setting('site.description') ?? "Et voluptate esse accusantium accusamus natus reiciendis quidem voluptates similique aut." }}</p>
            <div class="d-flex">
                <a href="#cta" class="btn-get-started scrollto">Iniciar</a>
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
                        ...
                        <div class="icon"><i class="bi bi-layout-text-window-reverse icon"></i></div>
                        <h4><a href="#featured-services" class="stretched-link">Páginas web</a></h4>
                        <p>Creación y mantenimiento de páginas web para todo tipo de negocios y empresas.</p>
                        </div>
                    </div><!-- End Service Item -->
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="200">
                        <div class="service-item position-relative">
                        <div class="icon"><i class="bi bi-code-slash icon"></i></div>
                        <h4><a href="#featured-services" class="stretched-link">Software a medida</a></h4>
                        <p>Desarrollo de sistemas web personalizados hecho a la medida de tus necesidades.</p>
                        </div>
                    </div><!-- End Service Item -->
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="400">
                        <div class="service-item position-relative">
                        <div class="icon"><i class="bi bi-list-check icon"></i></div>
                        <h4><a href="#featured-services" class="stretched-link">Consultoría</a></h4>
                        <p>Brindamos asesoramiento profesional en desarrollo y despliegue de aplicaciones web y móviles.</p>
                        </div>
                    </div><!-- End Service Item -->
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
                        <div class="service-item position-relative">
                            <div class="icon"><i class="bi bi-hdd-stack icon"></i></div>
                            <h4><a href="#featured-services" class="stretched-link">Hosting y dominio</a></h4>
                            <p>Si tienes tu página web o sistema te brindamos alojamiento en la nube seguro y confiable.</p>
                        </div>
                    </div><!-- End Service Item -->
                </div>
            </div>
